...
(async () => {
  ...
  /////////////////////////////////////////////////////////////////////////
  let url = "https://www.rendie.com/admin.html"
  ...
  while (Enable) {
    ...
    if(((count * 10) / 60)>3){//表示超过3分钟就截图
       await page.screenshot({path: '../sqlite3/error-5minute/overtime-' + count + '.png'});
    }
    /////////////////////////////////////////////////////
    try {
      ...
      await page.screenshot({
        path: '../sqlite3/error-5minute/error.png'
      });
      Enable = false;
    }
  }
